...
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        windowParams.width = VideoUtils.INSTANCE.getScreenHeight(context);
        windowParams.height = VideoUtils.INSTANCE.getScreenWidth(context);
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : VideoUtils.INSTANCE.dp2px(getContext(), 16f);
